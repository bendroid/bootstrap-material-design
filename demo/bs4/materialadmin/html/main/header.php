...
<div id="base">
			...
			<div id="menubar" class="menubar-inverse  animate">
				...
				<div class="nano has-scrollbar" style="height: 752px;"><div class="nano-content" tabindex="0" style="right: -21px;"><div class="menubar-scroll-panel" style="padding-bottom: 33px;">
					...
					<ul id="main-menu" class="gui-controls">
						...
						<li class="gui-folder active">
							...
							<ul>
								...
								<li class="active expanded"><a href="../../html/pages/blank.html" class="active"><span class="title">Blank page</span></a></li>
							</ul><!--end /submenu -->
						</li><!--end /menu-li -->
						<!-- END FORMS -->
					...
					<div class="menubar-foot-panel">
						<small class="no-linebreak hidden-folded">
							<span class="opacity-75">Copyright © 2014</span> <strong>Ben Collins</strong>
						</small>
					</div>
				</div></div><div class="nano-pane" style="display: none;"><div class="nano-slider" style="height: 732px; transform: translate(0px, 0px);"></div></div></div><!--end .menubar-scroll-panel-->
			</div><!--end #menubar-->
			<!-- END MENUBAR -->
				...
				<div id="offcanvas-demo-color1" class="offcanvas-pane style-primary offcanvas-pane width-4">
					...
					<div class="offcanvas-body">
						...
						<ul class="list-divided">
							<li><strong>Width</strong><br><span class="opacity-75">320px</span></li>
							...
							<li><strong>Background color</strong><br><span class="opacity-75">Primary</span></li>
						</ul>
					</div>
				</div>
